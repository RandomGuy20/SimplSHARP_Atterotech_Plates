...
namespace MediaStreamerDevices.AtteroTech.WallPlates
{
    public class unDX2IOPlusSIMPL
    {
        ...
        public delegate void DeviceInfoEventHandler(SimplSharpString DeviceName, SimplSharpString DeviceMAC);
        ...
        public DeviceInfoEventHandler onDeviceInfo { get; set; }
        ...
        void plate_onDeviceChange(WPDeviceEventArgs args)
        {
            ...
            onDeviceInfo(plate.DeviceName, plate.DeviceMac);
